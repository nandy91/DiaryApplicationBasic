package com.android.nanditha.diaryapplication;
...
public class MainActivity extends AppCompatActivity {
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!enterText.getText().toString().equals("")){
                    ...
                    writeToFile(data);
                    Toast.makeText(getApplicationContext(),"Your Secrets are saved !!", Toast.LENGTH_SHORT).show();

                }
                else{
                    Toast.makeText(getApplicationContext(),"Fill your Diary now!!", Toast.LENGTH_SHORT).show();
                }
    ...
    private void writeToFile(String myData) {
        ...
        try {
            ...
            e.printStackTrace();
         Log.v("MyActivity log",e.toString());
        }
